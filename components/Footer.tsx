    ...
    <footer className="bg-[#1C1C1C] text-[#FAF8F5] py-16">
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
          <div>
            <p className="font-semibold text-lg mb-2">Nomad Golf</p>
            <p className="text-[#6B6B6B] text-sm max-w-xs">
              Golf tools for people who play the game, not the image.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-8 text-sm text-[#A0A0A0]">
            ...
            <div className="flex flex-col gap-3">
              ...
              <a href="#" className="hover:text-[#FAF8F5] transition-colors">Instagram</a>
              <a href="#" className="hover:text-[#FAF8F5] transition-colors">TikTok</a>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-[#333] mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-[#6B6B6B] text-sm">
          <p>© 2026 Nomad Golf. All rights reserved.</p>
